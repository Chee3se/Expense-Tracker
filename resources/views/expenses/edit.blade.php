    ...
    <form action="/expenses/{{ $expense->id }}" method="POST" class="mx-auto mt-6 max-w-md flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col">
                ...
                <input type="date" name="date" id="date" class="border border-gray-200 rounded-lg p-2 focus:outline-none focus:ring focus:border-blue-300" value="{{ $expense->date }}" required>
            </div>
            <div class="flex flex-col">
